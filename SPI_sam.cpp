...
void SPIClass::begin() {
	...
	// Default speed set to 2Mhz
	setClockDivider(BOARD_SPI_DEFAULT_SS, SPI_CLOCK_DIV8);//8 
	setDataMode(BOARD_SPI_DEFAULT_SS, SPI_MODE0);//SPI_MODE0  SPI_MODE3
...
void SPIClass::begin(uint8_t _pin) {
	...
	// Default speed set to 2Mhz
	setClockDivider(_pin, SPI_CLOCK_DIV8);
